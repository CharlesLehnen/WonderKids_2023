...
# Ensure proper order for Test_Type and Class
fall_2023_data$Test_Type <- factor(fall_2023_data$Test_Type, levels = c("Pre-Test", "Post-Test"))
fall_2023_data$Class <- factor(fall_2023_data$Class, levels = c("K-2", "3-5"))
...
ggplot(fall_2023_data, aes(x = Test_Type, y = Percent, fill = Test_Type)) +
  ...
  scale_fill_manual(values = c("Pre-Test" = "#E69F00", "Post-Test" = "#56B4E9")) +  # Okabe-Ito colors
  theme(
...
ggplot(data_k5, aes(x = Test_Type, y = Percent, fill = Test_Type)) +
  ...
  geom_jitter(alpha = 0.3, width = 0.2) +
  labs(
    title = "Pre-Test vs. Post-Test Percentages (K-5 aggregated, Fall 2023)",
    x = "",
    y = "Percent (%)"
  ) +
  scale_fill_manual(values = c("Pre-Test" = "#E69F00", "Post-Test" = "#56B4E9")) +  # Okabe-Ito colors
